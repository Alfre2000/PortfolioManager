...
class RightFrame(ttk.Frame):
    ...
    def __init__(self, root, app):
        ...
        ttk.Separator(self, orient=HORIZONTAL).grid(row=1, column=0, sticky='nswe', padx=(0,30) )
        self.add_etf = AddEtf(self)
        self.add_etf.grid(row=2, column=0)
        ttk.Separator(self, orient=HORIZONTAL).grid(row=3, column=0, sticky='nswe', padx=(0,30))
